# Line-chart LineChart 折線圖

多系列折線圖組件，適合顯示趨勢變化和數據連續性
...
```tsx
import { Line-chart } from '@d3-components/basic';
...
| 屬性 | 類型 | 預設值 | 說明 |
|------|------|--------|------|
| `aria-label` | `string` | `'LineChart 折線圖'` | ARIA 標籤 |
