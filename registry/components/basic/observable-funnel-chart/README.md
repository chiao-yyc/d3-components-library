# Observable-funnel-chart observable-funnel-chart 組件
...
```tsx
import { Observable-funnel-chart } from '@d3-components/basic';
...
| 屬性 | 類型 | 預設值 | 說明 |
|------|------|--------|------|
| `aria-label` | `string` | `'observable-funnel-chart 組件'` | ARIA 標籤 |
...
### 繼承架構
```
Observable-funnel-chart (React Component)
└── D3Observable-funnel-chart (D3 Logic Class)
