# Bar-chart BarChart 長條圖

經典長條圖組件，支援橫向和縱向顯示，適合類別數據比較
...
```tsx
import { Bar-chart } from '@d3-components/basic';
...
| 屬性 | 類型 | 預設值 | 說明 |
|------|------|--------|------|
| `aria-label` | `string` | `'BarChart 長條圖'` | ARIA 標籤 |
