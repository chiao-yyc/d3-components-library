# Area-chart AreaChart 區域圖

可堆疊的區域圖組件，適合顯示時間序列數據和數量變化趨勢
...
```tsx
import { Area-chart } from '@d3-components/basic';
...
| 屬性 | 類型 | 預設值 | 說明 |
|------|------|--------|------|
| `aria-label` | `string` | `'AreaChart 區域圖'` | ARIA 標籤 |
