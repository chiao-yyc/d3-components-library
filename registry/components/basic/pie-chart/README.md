# Pie-chart PieChart 圓餅圖

圓餅圖和甜甜圈圖組件，適合顯示比例關係和佔比數據
...
```tsx
import { Pie-chart } from '@d3-components/basic';
...
| 屬性 | 類型 | 預設值 | 說明 |
|------|------|--------|------|
| `aria-label` | `string` | `'PieChart 圓餅圖'` | ARIA 標籤 |
