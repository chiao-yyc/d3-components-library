# Radar-chart RadarChart 雷達圖

多維度雷達圖組件，適合顯示多指標綜合評估
...
```tsx
import { Radar-chart } from '@d3-components/statistical';
...
| 屬性 | 類型 | 預設值 | 說明 |
|------|------|--------|------|
| `aria-label` | `string` | `'RadarChart 雷達圖'` | ARIA 標籤 |
