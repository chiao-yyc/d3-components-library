...
// 擴展 React props 接口
export interface ScatterPlotV2Props extends ReactChartWrapperProps, ScatterPlotCoreConfig {
...
// 導出最終組件
export const ScatterPlotV2 = React.forwardRef<ScatterPlotCore, ScatterPlotV2Props>((props, ref) => {
...
export const ScatterPlotWithLegacySupport = React.forwardRef<ScatterPlotCore, 
  ScatterPlotV2Props & ScatterPlotPropsLegacy
>((props, ref) => {
  // 將舊的 props 轉換為新格式
  const {
  ...
  const finalProps: ScatterPlotV2Props = {
    ...modernProps,
  ...
  return <ScatterPlotV2 ref={ref} {...finalProps} />;
});
