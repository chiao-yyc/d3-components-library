# Correlogram Correlogram 相關性矩陣

相關性矩陣視覺化組件，適合顯示變數間相關係數
...
```tsx
import { Correlogram } from '@d3-components/statistical';
...
| 屬性 | 類型 | 預設值 | 說明 |
|------|------|--------|------|
| `aria-label` | `string` | `'Correlogram 相關性矩陣'` | ARIA 標籤 |
...
### 繼承架構
```
Correlogram (React Component)
└── D3Correlogram (D3 Logic Class)
