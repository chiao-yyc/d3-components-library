# Violin-plot ViolinPlot 小提琴圖

小提琴圖組件，結合盒型圖和密度圖的統計視覺化
...
```tsx
import { Violin-plot } from '@d3-components/statistical';
...
| 屬性 | 類型 | 預設值 | 說明 |
|------|------|--------|------|
| `aria-label` | `string` | `'ViolinPlot 小提琴圖'` | ARIA 標籤 |
...
### 繼承架構
```
Violin-plot (React Component)
└── D3Violin-plot (D3 Logic Class)
