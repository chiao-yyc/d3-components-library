...
async function setConfig(config: any, key?: string, value?: string, configPath: string, options: ConfigOptions) {
...
async function unsetConfig(config: any, key?: string, configPath: string, options: ConfigOptions) {
  if (!key) {
